...
Client::Client()
	: server_socket_handle_(-1), connected_(false)
{
}
...
{
	if (!connected_) { WARNING("Not connected."); return; }
	Message msg; msg.type = MessageType::GET_TIME; memset(msg.data,0,sizeof(msg.data));
	::send(server_socket_handle_, &msg, sizeof(msg), 0);
}
...
{
	if (!connected_) { WARNING("Not connected."); return; }
	Message msg; msg.type = MessageType::GET_NAME; memset(msg.data,0,sizeof(msg.data));
	::send(server_socket_handle_, &msg, sizeof(msg), 0);
}
...
{
	if (!connected_) { WARNING("Not connected."); return; }
	Message msg; msg.type = MessageType::GET_CLIENT_LIST; memset(msg.data,0,sizeof(msg.data));
	::send(server_socket_handle_, &msg, sizeof(msg), 0);
}
